...
@prueba1
  Scenario Outline: Verificar el registro de usuario
    ...
    Examples:
      ...
      | Nayelly     | Valenzuela |  964926164 | 987654321 | calle lima 123      | lima     | Lima        | 11001   | naye0102     | Clave123 | Clave123    | Your account was created successfully. You are now logged in.  |
